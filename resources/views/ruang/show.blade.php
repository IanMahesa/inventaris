...
<div class="container-fluid">
    ...
    <h2 class="mb-2 d-none d-md-block role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-eye me-3"></i> Detail Ruangan
        </span>
    </h2>
    {{-- Versi KECIL (Ponsel/Mobile) --}}
    <h5 class="mb-2 d-md-none role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-eye me-2"></i> Detail Ruangan
        </span>
    </h5>
        ...
        <div class="card">
            <div class="card-body p-4">
                        ...
                        <table class="table table-bordered text-first align-middle mb-0">
                            <thead class="table-gradient-header">
                                <tr class="table-info text-white">
                                    <th width="30%"><strong>Kode Ruangan</strong></th>
                                    <td class="td-mode">{{ $ruang->code }}</td>
                                </tr>
                                <tr class="table-info text-white">
                                    <th><strong>Nama Ruangan</strong></th>
                                    <td class="td-mode">{{ $ruang->name }}</td>
                                </tr>
                            </thead>
                        </table>
                    </div>
                ...
                <div class="d-flex justify-content-first mt-3 aksi-back ms-3">
                    <a href="{{ route('ruang.index') }}" class="btn btn-primary btn-sm">
