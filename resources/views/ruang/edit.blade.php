...
<div class="container-fluid">
    ...
    <h2 class="mb-2 d-none d-md-block role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-edit me-3"></i> Edit Kode Ruangan
        </span>
    </h2>
    {{-- Versi KECIL (Ponsel/Mobile) --}}
    <h5 class="mb-2 d-md-none role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-edit me-2"></i> Edit Kode Ruangan
        </span>
    </h5>
    ...
    <div class="section-body my-4">
        <div class="card">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('ruang.update', $ruang->code) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12 col-md-3 mb-3">
                            <label for="code" class="form-label">Kode Ruangan</label>
                            <input class="form-control" type="text" name="code" id="code" placeholder="Kode Ruangan" required value="{{ $ruang->code }}">
                        </div>
                        <div class="col-12 col-md-9 mb-3">
                            <label for="name" class="form-label">Nama Ruangan</label>
                            <input class="form-control" type="text" name="name" id="name" placeholder="Nama Ruangan" required value="{{ $ruang->name }}">
                        </div>
                    </div>
