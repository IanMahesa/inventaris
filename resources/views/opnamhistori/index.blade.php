...
<style>
    ...
    /* Mobile: make Cari and Reset buttons 50:50 and full width */
...
<div id="opnamhistori-page" class="container-fluid px-3 px-md-4" data-anyfilled="{{ request()->anyFilled(['date', 'periode', 'code_kategori', 'nama_brg', 'merk', 'seri', 'code_ruang']) ? '1' : '0' }}">

    {{-- Versi BESAR (Desktop/Tablet) --}}
    <h2 class="mb-2 d-none d-md-block role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-cog me-3"></i>Pindah Ruang Aset
        </span>
    </h2>
    {{-- Versi KECIL (Ponsel/Mobile) --}}
    <h5 class="mb-2 d-md-none role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-cog me-2"></i> Pindah Ruang Aset
        </span>
    </h5>
    ...
    <div class="row">
        ...
        <div class="col-md-3"> <!-- dari col-md-4 → col-md-3 -->
            <div class="card mb-4" style="max-height: 90vh; overflow-y: auto; padding: 10px;">
                <div class="card-body p-2"> <!-- padding dikurangi -->
                    <form id="searchForm" method="GET" action="{{ route('opnamhistori.index') }}">
                        <div class="mb-2">
                        ...
                        <div class="mb-2 position-relative">
                            ...
                            <div class="position-relative">
                                <select name="code_kategori" class="form-control form-control-sm pe-4" onchange="this.form.submit()">
                        ...
                        <div class="mb-2 position-relative">
                            ...
                            <div class="position-relative">
                                <select name="code_ruang" class="form-control form-control-sm pe-4" onchange="this.form.submit()">
                        ...
                        <div class="btn-row d-flex gap-1 mt-3 w-100 aksi-filter aksi-reset">
                            ...
                            <a href="{{ route('opnamhistori.index') }}" class="btn btn-secondary btn-sm w-100">
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div class="table-responsive">
                        <table id="filteredTable" class="table table-hover table-bordered display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center td-aksi">
                                        @can('histori-edit')
                                        <a href="{{ route('aset.histori.edit', ['id' => $item->id_aset, 'st_histori' => 'PDH']) }}" class="btn btn-sm btn-warning" title="Edit Pindah Ruang">
...
<script>
    $(document).ready(function() {
        ...
        const anyFilled = document.getElementById('opnamhistori-page').dataset.anyfilled === '1';
        if (anyFilled) {
