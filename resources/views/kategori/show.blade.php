...
<div class="container-fluid">
    ...
    <h2 class="mb-2 d-none d-md-block role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-eye me-3"></i> Detail Jenis Barang
        </span>
    </h2>
    {{-- Versi KECIL (Ponsel/Mobile) --}}
    <h5 class="mb-2 d-md-none role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-eye me-2"></i> Detail Jenis Barang
        </span>
    </h5>
                        ...
                        <table class="table table-bordered text-first align-middle mb-0">
                            <thead class="table-gradient-header">
                                <tr class="table-info text-white">
                                    <th width="30%"><strong>Kode Jenis Barang :</strong></th>
                                    <td class="td-mode">{{ $kategori->kode }}</td>
                                </tr>
                                <tr class="table-info text-white">
                                    <th><strong>Nama Jenis Barang :</strong></th>
                                    <td class="td-mode">{{ $kategori->nama }}</td>
                                </tr>
                            </thead>
                        </table>
                    </div>
