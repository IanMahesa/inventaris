...
<div class="container-fluid">
    ...
    <h2 class="mb-2 d-none d-md-block role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-edit me-3"></i> Edit Pindah Ruang Aset
        </span>
    </h2>
    {{-- Versi KECIL (Ponsel/Mobile) --}}
    <h5 class="mb-2 d-md-none role-title">
        <span class="role-content">
            <i class="fas fa-fw fa-edit me-2"></i> Edit Pindah Ruang Aset
        </span>
    </h5>
    ...
    <div class="section-body mb-5">
        <div class="card">
            <div class="card-body p-4">
                <form action="{{ route('aset.histori.update', $aset->id_aset) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-12 col-md-8">
                            <div class="row">
                                <div class="col-12 col-md-3 mb-3">
                                    ...
                                    <input type="hidden" name="st_histori" value="PDH">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" name="r_sebelum" class="form-control"
                                        value="{{ old('r_sebelum', $aset->ruang->name ?? '') }}" readonly required>
                                </div>
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="r_sesudah" id="r_sesudah">
                            ...
                            <div class="mb-3 d-flex flex-column align-items-center aksi-filter aksi-galeri">
                                <div class="border border-secondary rounded p-3 d-flex flex-column align-items-center w-100 mb-3" style="max-width: 370px;">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-sm mb-2" onclick="document.getElementById('galleryInputHistoriEdit').click()">
                                        <i class="fas fa-image me-1"></i> Ambil Galeri
                                    </button>
                                    <input type="file" id="galleryInputHistoriEdit" accept="image/*" multiple style="display:none;" />
                                    ...
                                    @for($i = 1; $i <= 4; $i++)
                                        ...
                                        <div class="d-flex flex-column align-items-center p-2 border rounded aksi-hapus" style="min-height:240px;">
                                            ...
                                            <img id="foto_lama_{{ $i }}"
                                                ...
                                                loading="lazy">
                                            <input type="hidden" name="foto_lama_{{ $i }}" value="{{ $url }}">
                                            @else
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const galleryInputHistoriEdit = document.getElementById('galleryInputHistoriEdit');
        if (galleryInputHistoriEdit) {
            galleryInputHistoriEdit.addEventListener('change', async function() {
                const files = Array.from(galleryInputHistoriEdit.files || []);
